...
return [
    "text_banner_1" => "Layanan Perawatan",
    "text_banner_2" => "Demam Berdarah di Rumah",
    "text_banner_3" => "",
    "text_banner_button" => "Konsul dengan Dokter",
    "section_2" => [
        "txt_header" => "Gejala-Gejala Demam Berdarah Dengue",
        "txt_1" => "Demam Tinggi",
        "txt_2" => "Nyeri sendi/otot",
        "txt_3" => "Mual",
        "txt_4" => "Kulit Bintik Merah",
        "txt_5" => "Nyeri Ulu Hati",
        "txt_6" => "Diare",
    ],
    "section_3" => [
        "harga" => "Harga Spesial",
        ...
        "tac" => [
            ...
            "point_1_1" => "Trombosit Pasien dibawah 40.000",
            "point_1_2" => "direkomendasikan untuk perawatan lebih lanjut ke Rumah Sakit.",
            "point_2_1" => "Masa Perawatan Minimal 3 Hari",
            "point_2_2" => "Untuk memastikan efektivitas perawatan, Namun durasi perawatan dapat diperpanjang sesuai kebutuhan.",
        ],
    ],
    "section_4" => [
    ...
    "section_6" => [
        "txt_header" => "Ada Pertanyaan?",
        "text_1" => "Tim kami siap membantu Anda secara langsung",
        "text_button" => "Konsultasi dengan Dokter",
    ],
    "section_7" => [
        "text_header" => "Testimonia Pelanggan",
        "testi_1" => "Apoteker sangat membantu dalam menjawab pertanyaan saya. Sangat direkomendasikan!",
        "testi_2" => "Layanan perawatan demam berdarah di rumah membuat proses pemulihan lebih mudah. Tim medis berpengalaman, memberikan dukungan psikologis, dan sangat direkomendasikan.",
        "testi_3" => "Banyak pilihan produk dan situs web yang sangat ramah pengguna."
    ],
    "footer" => [
