    ...
    <div class="content">
        <section class="banner-pages homepage">
            <div class="text">
                ...
                <a onclick="directurl('wa')" class="btn btn-whatsapp fs-14"><i class="mdi mdi-whatsapp fs-18 me-2"></i> {{__('index.text_banner_button')}} </a>
            </div>
        </section>
        ...
        <section class="question">
            <div class="container">
                ...
                <a onclick="directurl('wa')" class="btn btn-whatsapp"><i class="mdi mdi-whatsapp fs-18 me-2"></i>
